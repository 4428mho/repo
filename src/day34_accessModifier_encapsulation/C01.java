...
public class C01 {
    ...
    static int acikSayi=20;  // access modifier'i default Access Modifier, defoult modifay başında bir ifade olmaz.
   ...
   protected C01(){
    ...
    }//boş method . private modifaya sadece class içinden ulaşılabilir.
    // başka yerden çalışmaz.
